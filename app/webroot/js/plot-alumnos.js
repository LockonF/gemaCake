$(document).ready(function(){
    ...
    $.getJSON('getDatosAlumno.json', function(raw_data){
        //raw_data = jQuery.parseJSON(raw_data);
        console.log(raw_data);
        var dataAvances = {
            labels: raw_data['data']['response']['avances']['labels'],
            datasets: [

                {
                    ...
                    data: raw_data['data']['response']['avances']['periodos']['actual']
                },
                {
                    ...
                    data: raw_data['data']['response']['avances']['periodos']['anterior']
                }
            ]
        };
        ...
        var dataPromedios = {
            labels: raw_data['data']['response']['promedios']['labels'],
            datasets: [
                {
                    label: "Promedios",
                    ...
                    pointHighlightStroke: "rgba(220,220,220,1)",
                    data: raw_data['data']['response']['promedios']['data'].reverse()
                },
